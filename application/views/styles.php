...
<div  class="section"id="styles">
	...
	<div class="section padding-top-1st padding-bottom-1st over-hide">
		<div class="parallax" style="background-image: url('<?php echo base_url();?>/resources/img/styles_wallpaper.jpg')"></div>
		<div class="light-fade-over-3" style="opacity: 0.10"></div>
		<div class="container z-bigger">
			<div class="row justify-content-center">
				<div class="col-md-7 parallax-fade-top">	
					<div class="main-title text-center mb-0">
					<br><br><br><br><br>
                        <h3 style="background-color: white; color:black;">Specialized in all styles.</h3>
		...
		<div class="container-fluid px-4">
			<div class="row">
				<div class="grid-wraper clearfix">	
					...
					?>
					<div class="grid-box float-inline half with-margin photo motion">
						<a href="#">
							<div class="portfolio-box-1 rounded">	
								<img  src="<?php echo base_url();?>/resources/img/style<?php echo $row['id'];?>.jpg" alt="" />	
								<div class="portfolio-mask-3 rounded"></div>
								<h5 class="on-center text-center">
								<?php echo $row['name'];?></h5>
								<p class="on-center text-center">
			...
			<div class="row justify-content-center" data-scroll-reveal="enter bottom move 40px over 0.8s after 0.2s">
				<div class="col-md-8">	
					<div class="quote-box-1 text-center">
						<h5 class="mb-5">"When you dance, your purpose is not to get to a certain place on the floor. It's to enjoy each step along the way."</h5>
						<h4>Oyen Richstone</h4>
						<p class="mt-2">IITU magazine</p>
					</div>
				</div>
			</div>	
		</div>		
