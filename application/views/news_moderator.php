				...
				<div class="col-lg-4 pt-3">
					<div class="sidebar-box background-white drop-shadow rounded">
						<div class="subscribe-box-1">
							<input type="text" value="" placeholder="type search here" class="form-control" />
						...
						<ul class="list-style circle pl-4 pb-0">	
							<li>
								<a href="#" class="btn-link btn-primary pl-0">modern</a>
							</li>
							<li>
								<a href="#" class="btn-link btn-primary pl-0">jazz</a>
							</li>
							<li>
								<a href="#" class="btn-link btn-primary pl-0">classic</a>
							</li>
							<li>
								<a href="#" class="btn-link btn-primary pl-0">stip plastic</a>
							</li>
							<li>
								<a href="#" class="btn-link btn-primary pl-0">street dance</a>
							</li>
							<li>
								<a href="#" class="btn-link btn-primary pl-0">east styles</a>
							</li>
						</ul>
						<div class="clear"></div>	
						<div class="separator-wrap my-5">	
						...
						<div class="video-section">
							<figure class="vimeo"> 
								<a href="https://player.vimeo.com/video/219627581">
									<img src="<?php echo base_url();?>/resources/img/lastest_video.jpg" width="120%" alt="image" class="blog-home-img" />
								</a>
							</figure>
						</div>
						<div class="clear"></div>	
						...
						<a href="#" class="btn btn-primary btn-sm ml-0 mr-1 mb-1">modern</a>
						<a href="#" class="btn btn-primary btn-sm ml-0 mr-1 mb-1">old</a>
						<a href="#" class="btn btn-primary btn-sm ml-0 mr-1 mb-1">dance</a>
						<a href="#" class="btn btn-primary btn-sm ml-0 mr-1 mb-1">street</a>
						<a href="#" class="btn btn-primary btn-sm ml-0 mr-1 mb-1">classic</a>
						<a href="#" class="btn btn-primary btn-sm ml-0 mr-1 mb-1">polish</a>
						<a href="#" class="btn btn-primary btn-sm ml-0 mr-1 mb-1">sweden</a>
						<a href="#" class="btn btn-primary btn-sm ml-0 mr-1 mb-1">media</a>
						<a href="#" class="btn btn-primary btn-sm ml-0 mr-1 mb-1">beautiful</a>
						<a href="#" class="btn btn-primary btn-sm ml-0 mr-1 mb-1">dancers</a>
						<a href="#" class="btn btn-primary btn-sm ml-0 mr-1 mb-1">gallery</a>
						<a href="#" class="btn btn-primary btn-sm ml-0 mr-1 mb-1">grace</a>
						<a href="#" class="btn btn-primary btn-sm ml-0 mr-1 mb-1">ballet</a>
						<a href="#" class="btn btn-primary btn-sm ml-0 mr-1 mb-1">professional</a>
						<div class="clear"></div>	
						<div class="separator-wrap my-5">	
							<span class="separator"><span class="separator-line dashed"></span></span>
						</div>
						...
						<ul class="list-style circle-o pl-4 pb-0">	
							<li>
								<a href="#" class="btn-link btn-primary pl-0">february 2018</a>
							</li>	
							<li>
								<a href="#" class="btn-link btn-primary pl-0">january 2018</a>
							</li>	
							<li>
								<a href="#" class="btn-link btn-primary pl-0">december 2017</a>
							</li>	
							<li>
								<a href="#" class="btn-link btn-primary pl-0">november 2017</a>
							</li>
						</ul>
						<div class="clear"></div>	
					</div>
					...
					<div class="grid-wraper clearfix">	
						<div class="grid-box with-margin drop-shadow rounded">						 
							<div class="blog-box-1 blog-home background-white over-hide">
								...
								<h5 class="pt-4 mt-3">Add new post</h5>
								<?php
									echo form_open_multipart(base_url().'index.php/blog/post_add', array('id' => 'img'));
									$now = date('Y-m-d H:i:s');
									echo form_hidden('date',$now);
									echo form_hidden('user',$_SESSION['userid']);
								?>
								<div class="clear"></div>
								<div class="clear"></div>
								<input type="file" name="pic" tabindex="2">
								<div class="subscribe-box-1 mt-3">
									<input type="text" name = "title" value="" placeholder="What about?" class="form-control" />
								</div>
								<div class="clear"></div>
								<div class="subscribe-box-1 mt-4">
									<textarea name="context"  placeholder="What's new, man?" class="for-textarea form-control" ></textarea>
								</div>
								<div class="clear"></div>
								<button class="btn btn-primary btn-round btn-long mt-5" type="submit">Post</button>
								<?php 
									echo form_close();
								?>								
								</div>
