				...
				<div class="row justify-content-center">
					<div class="col-md-4 text-center parallax-fade-top">	
						<div class="main-title on-dark text-center mb-0">
							...
							<div class="main-subtitle-bottom smaller mt-4">Enter data please:</div>	
						</div>	
						...
						<p style="color:#bfbfbf">Gender</p>
						<div class="radio success">
							<input type="radio" name="radio13" id="radio13" value="option1">
							<label style="color:#bfbfbf" for="radio13">
								Female
							</label>
							<input type="radio" name="radio13" id="radio14" value="option2" checked="">
							<label style="color:#bfbfbf" for="radio14">
								Male
							</label>
						</div>
						</div>
